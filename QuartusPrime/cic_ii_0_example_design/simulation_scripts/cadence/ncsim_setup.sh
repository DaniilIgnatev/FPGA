...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  cp -f $QSYS_SIMDIR/../test_data/cic_ii_0_example_design_rate_input.txt ./
  cp -f $QSYS_SIMDIR/../test_data/cic_ii_0_example_design_tb_input.txt ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/auk_dspip_delay.vhd"                     -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/auk_dspip_fastaddsub.vhd"                -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/auk_dspip_fastadd.vhd"                   -work work -cdslib ./cds_libs/work.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../src/auk_dspip_pipelined_adder.vhd"           -work work -cdslib ./cds_libs/work.cds.lib
  ...
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/../src/cic_ii_0_example_design.v"               -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cic_ii_0_example_design_core.sv"         -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/../src/cic_ii_0_example_design_tb.v"            -work work -cdslib ./cds_libs/work.cds.lib
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../src/cic_ii_0_example_design_test_program.sv" -work work -cdslib ./cds_libs/work.cds.lib
fi
